<?php
	...
	require_once('C:/xampp/htdocs/Mock_test_1/search_library/search.php');

	require_once('C:/xampp/htdocs/Mock_test_1/pagination1.0/prepared_query.php');
	...
	Class ManageApp {
		...
		{   
        	...
        	$extra_slots_entry= mysqli_prepared_query($connection_mock_chat,$query,"ii",$params);
				//echo "<pre>";print_r($extra_slots_entry);echo "</pre>";
